          ...
          <div className="space-y-8">
            ...
            <div className="space-y-3">
              ...
              <p className="max-w-md text-sm text-neutral-300">
                Track orders, inventory, dealers, and promotions in one place with consistent admin workflows.
              </p>
            </div>
          </div>
        ...
        <Card className="mx-auto w-full max-w-md border-neutral-800 bg-neutral-900/85 shadow-2xl backdrop-blur">
          ...
          <CardFooter>
            <p className="text-xs text-neutral-500">
              This is a frontend-only authentication experience for UI validation.
            </p>
          </CardFooter>
        </Card>
      </div>
